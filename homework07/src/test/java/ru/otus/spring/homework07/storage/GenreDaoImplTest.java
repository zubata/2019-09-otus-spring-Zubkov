...
class GenreDaoImplTest {
    ...
    @Test
    void getByName() {
        val actual = genreDaoImpl.getBygenreName(DEFAULT_NAME);
        assertThat(actual).
    ...
    void delete() {
        long tempId = (long) tem.persistAndGetId(new Genre(TEST_GENRENAME));
        genreDaoImpl.deleteById(tempId);
    ...
    void getAll() {
        ...
        assertThat(genreDaoImpl.findAll()).usingFieldByFieldElementComparator().isEqualTo(list);
    }
}