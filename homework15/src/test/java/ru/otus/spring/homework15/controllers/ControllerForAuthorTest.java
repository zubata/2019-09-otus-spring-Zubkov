...
class ControllerForAuthorTest {
    ...
    @MockBean
    private GatewayForAuthor gateway;
    @MockBean
    ...
    void getAuthorById1() throws Exception {
        given(gateway.forFindAuthor(1)).willReturn(TEST_AUTHOR);
    ...
    void getAuthorAll1() throws Exception {
        ...
        given(gateway.forListAuthor()).willReturn(list);
    ...
    void insertAuthor1() throws Exception {
        given(gateway.forInsertAuthor(any())).willReturn(TEST_AUTHOR);
    ...
    void deleteAuthorById1() throws Exception {
        given(gateway.forDeleteAuthor(anyLong())).willReturn("Автор с id 1 удален из БД");
