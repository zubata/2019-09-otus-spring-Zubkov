...
class ControllerForCommentTest {
    ...
    @MockBean
    private GatewayForComment commentService;
    @MockBean
    ...
    void getCommentByBook1() throws Exception {
        ...
        given(commentService.forListByBook(any())).willReturn(list);
    ...
    void insertComment1() throws Exception {
        given(commentService.forInsertComment(any())).willReturn(TEST_COMMENT_1);
    ...
    void deleteCommentById1() throws Exception {
        ...
        given(commentService.forDeleteComment(anyLong())).willReturn("Комментарий удалён");
