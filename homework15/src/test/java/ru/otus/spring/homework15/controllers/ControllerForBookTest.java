...
import ru.otus.spring.homework15.security.MyPersonDetailsService;
...
class ControllerForBookTest {
    ...
    @MockBean
    private GatewayForBook gatewayForBook;
    @MockBean
    private GatewayForAuthor gatewayForAuthor;
    @MockBean
    ...
    void getBookById1() throws Exception {
        given(gatewayForBook.forFindBook(1)).willReturn(TEST_BOOK_1);
    ...
    void getBookAll1() throws Exception {
        ...
        given(gatewayForBook.forListBook()).willReturn(list);
    ...
    void insertBook1() throws Exception {
        given(gatewayForBook.forInsertBook(any())).willReturn(TEST_BOOK_1);
    ...
    void getPageInsert1() throws Exception {
        ...
        given(gatewayForAuthor.forListAuthor()).willReturn(authors);
    ...
    void deleteBookById1() throws Exception {
        given(gatewayForBook.forDeleteBook(anyLong())).willReturn("Книга с названием Война и Мир удалена из БД");
